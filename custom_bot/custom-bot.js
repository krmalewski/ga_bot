...
CustomBot.prototype.help = function(){
  this.bot.sendMessage(
    ...
    "To join the queue, you must have a particular question attached to the command. Type `queue me Javascript is hard` or `q me i don't understand functions` to queue yourself. This way, Master Krystyna can help in the best way possible. " +
...
CustomBot.prototype.respond = function(message){
  ...
  switch(text){
    ...
    case "r2":
      ...
      break;
    case "obey":
      this.bot.sendMessage(this.channel, 'I only obey Master Krystyna');
      break;
    case "threepio":
